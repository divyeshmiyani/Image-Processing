# Objective: Observed the effect of the following low pass filter on image. (I)Ideal (II)Butterworth (III)Gaussian
...
cv2.imshow('Filtered Image', out_img[0:nr, 0:nc])
cv2.waitKey(0)
cv2.destroyAllWindows()

# Plot the images 
titles = ['Input Image', 'Spectrum', 'Filter', 'Filtered Image']
